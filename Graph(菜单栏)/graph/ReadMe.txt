================================================================================
MICROSOFT 基础类库: graph 项目概述
===============================================================================

应用程序向导已为您创建了这个 graph 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
graph.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CgraphApp 应用程序类。

graph.cpp
这是包含应用程序类 CgraphApp 的主要应用程序源文件。

graph.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\graph.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 graph.rc 中。
...
graphDoc.h，graphDoc.cpp - 文档
这些文件包含 CgraphDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CgraphDoc::Serialize)。

graphView.h，graphView.cpp - 文档的视图
这些文件包含 CgraphView 类。
CgraphView 对象用于查看 CgraphDoc 对象。
